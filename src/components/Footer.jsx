...
export const Footer = () => {
    return (
        <footer className="flex justify-center items-center p-4 bg-gray-200 mt-56">
            <a href="https://github.com/hellen-silvaa" target="_blank" rel="noopener noreferrer" className="flex items-center text-black no-underline">
               {/* //icone github em svg  */}
                ...
                <span className="ml-2">Hellen Silva</span>
            </a>
        </footer>
    );
};